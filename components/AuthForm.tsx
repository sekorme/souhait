        ...
        <>
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="auth-form">
                    ...
                    {type === "sign-up" && ["name", "phone", "country","city","dob"].map((field) => (
                        <FormField
                            key={field}
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel className="shad-form-label">{field.name}</FormLabel>
                                    <FormControl>
                                        <Input placeholder={`Enter your ${field.name}`} className="shad-input" {...field} />
                                    </FormControl>
